          ...
          <div className=" w-5/6 flex flex-col gap-4 text-black p-4">
            <div className="w-full flex flex-col">
              <input
                ...
                name="fullname"
                className="mx-auto w-11/12 rounded-lg lg:w-[30rem] py-2 px-4 border border-neutral-300"
              />
              {errors && (
            ...
            <div className="grid w-11/12 mx-auto grid-cols-1 gap-4 lg:grid-cols-2 lg:mx-auto lg:w-[30rem]">
              <div className="flex flex-col">
                <input
                  ...
                  onChange={handleChange}
                  name="email"
                  className="rounded-lg w-full py-2 px-4 border border-neutral-300"
                  error={errors.email}
                />
                {errors && (
            ...
            <div className="flex flex-col">
              <textarea
                ...
                placeholder="Message"
                name="message"
                className="w-11/12 lg:w-[30rem] h-[10rem] mx-auto rounded-lg py-2 px-4 border border-neutral-300"
                onChange={handleChange}
              />
              {errors && (
